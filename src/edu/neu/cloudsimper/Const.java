...
public class Const {
	...
	public static final String CONIF_FILE_DATACENTER = CONIF_FILE_ROOT + "edu/neu/cloudsimper/_conf/Datacenter.xml";
	public static final String CONIF_FILE_HOST = CONIF_FILE_ROOT + "edu/neu/cloudsimper/_conf/Host.xml";
	public static final String CONIF_FILE_PLUGIN_INFOR = CONIF_FILE_ROOT + "edu/neu/cloudsimper/_conf/Plugin.xml";
	public static final String CONIF_FILE_REGION = CONIF_FILE_ROOT + "edu/neu/cloudsimper/_conf/Region.xml";
	public static final String CONIF_FILE_REQUEST = CONIF_FILE_ROOT + "edu/neu/cloudsimper/_conf/Request.xml";
	public static final String CONIF_FILE_ENERGY = CONIF_FILE_ROOT + "edu/neu/cloudsimper/_conf/Energy.xml";
	public static final String CONIF_FILE_BATTERY = CONIF_FILE_ROOT + "edu/neu/cloudsimper/_conf/Battery.xml";

	public static final String CONIF_FILE_ENERGY_DATA = CONIF_FILE_ROOT + "edu/neu/cloudsimper/_conf/energy/";
	public static final String CONIF_FILE_REQUEST_DATA = CONIF_FILE_ROOT + "edu/neu/cloudsimper/_conf/trace/";
