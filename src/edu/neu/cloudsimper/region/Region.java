...
public class Region extends GeoInfor {
	...
	public double getPopulation() {
		return Double.parseDouble(getAttribute(Const.V_POPULATIONDENSITY));
	}

	public double getRegionSize() {
		return Double.parseDouble(getAttribute(Const.V_REFIONSIZE));
	}

	public double getTimeShift() {
		return Double.parseDouble(getAttribute(Const.V_TIMESHIFT));
	}
